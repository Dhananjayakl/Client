...
const RegulatoryBUreview = ({ objectId }) => {
      ...
      <>
        ...
        <Container fluid className="p-0 ">
          ...
          <Row id="scrollspyHeading1">
            ...
            <LandingPagesTitle title={"Compliance Review Assessments"} />
          ...
          {privs.includes("CT_CREATE_TEST_EXECUTION") && (
            <Row id="scrollspyHeading1">
              ...
              {/* <Col lg={9}>
                <Chart chart="CT_CONTROL_HEAT_MAP"  defaultFilter={{processId: framework}} />
              </Col> */}
            </Row>
          )}
  ...
  export default RegulatoryBUreview;