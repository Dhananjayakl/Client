...
function getService(service) {
  switch (service) {
    ...
    case "presentFinanceyearTotalcount":
      return "/grc/countofPresentyear";
    case "countOfPreviousFinanceYear":
      return "/grc/countofPreviousFinanceYear"
    case "countofFramework":
      return "/grc/countofFramework";
    case "totalLoss":
      return "/grc/totalloss";
    case "vendorsummary":
      return "/grc/vendorsummary";
    case "issueSummary":
      return "/grc/issuesummary";
    default:
      break;
  }
}
...
export function getPresentFinanceyearTotalcount(service, orgId,year) {
  const API_BASE_URL = getService(service);
...
export function getCountOfPreviousFinanceYear(service, orgId,year) {
  const API_BASE_URL = getService(service);
  const param = "?orgId=" + orgId + "&year=" + year;
  const url = API_BASE_URL + param;
  return axios.get(url);
...
export function getCountofFramework(service, orgId,year) {
  const API_BASE_URL = getService(service);
  const param = "?orgId=" + orgId + "&year=" + year;
  const url = API_BASE_URL + param;
  return axios.get(url);
...
export function getTotalLoss(service, orgId,year) {
  const API_BASE_URL = getService(service);
  const param = "?orgId=" + orgId + "&year=" + year;
  const url = API_BASE_URL + param;
  return axios.get(url);
...
export function getVendorsummary(service, orgId, year){
  const API_BASE_URL = getService(service);
  const param = "?orgId=" + orgId + "&year=" + year;
  const url = API_BASE_URL + param;
  return axios.get(url);
...
export function getIssueSummary(service, orgId, year){
  const API_BASE_URL = getService(service);
  const param = "?orgId=" + orgId + "&year=" + year;
  const url = API_BASE_URL + param;
  return axios.get(url);
...
export function getCountoflastquarted(service, id, startFY, endFY) {
  const API_BASE_URL = getService(service);
  const param = "?orgId=" + id + "&startFY=" + startFY + "&endFY=" + endFY;
  const url = API_BASE_URL + param;
  return axios.get(url);
}
