...
const JSHook = (form, formMetaData, formMethods, formValues) => {
  form.onLoad = (props) => {
    ...
    formMetaData.fields.violation.visible = false;
    formMetaData.fields.technicalFeasibilityExceptions.visible = false;
    formMetaData.fields.violationRiskFactor.visible = false;
    formMetaData.fields.tier.visible = false;
    formMetaData.fields.year.visible = false;
    const hierarchyValue = formMethods.getValues("hierarchy");
    const details = formMethods.getValues("typeOfCompliance");
    ...
    if (details && details == 5) {
      formMetaData.fields.violation.visible = true;
      formMetaData.fields.technicalFeasibilityExceptions.visible = true;
      formMetaData.fields.violationRiskFactor.visible = true;
      formMetaData.fields.tier.visible = true;
      formMetaData.fields.year.visible = true;
    } else {
      formMetaData.fields.violation.visible = false;
      formMetaData.fields.technicalFeasibilityExceptions.visible = false;
      formMetaData.fields.violationRiskFactor.visible = false;
  ...
  form.typeOfCompliance.onChange(function (value) {
    if (value == 5) {
      formMetaData.fields.violation.visible = true;
      formMetaData.fields.technicalFeasibilityExceptions.visible = true;
      formMetaData.fields.violationRiskFactor.visible = true;
      ...
      formMetaData.fields.tier.visible = false;
      formMetaData.fields.year.visible = false;
      formMethods.setValue("violation", "");
      formMethods.setValue("violationRiskFactor", "");
      formMethods.setValue("tier", "");
      formMethods.setValue("year", "");
      formMethods.setValue("technicalFeasibilityExceptions", "");
    }
  });
  ...
  form.reviewCycle.onChange((value) => {
    formValues.reviewCycle = value;
  ...
  form.year.onChange((value) => {
    if (value.length <= 4) {
      formMethods.setValue("year", value);
    } else {
      const truncatedValue = value.slice(0, 4);
      formMethods.setValue("year", truncatedValue);
    }
  });
