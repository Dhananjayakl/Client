  ...
  return (
    <>
      ...
      <Container fluid className="p-0 ">
        ...
        <div className="">
          {privs.includes("PM_CREATE_TICKET") && (
            <>
              <Row>
                <ReportRuntime report="PM_TICKET_LIST" dataCard />
              </Row>
              <Row>
                <ReportRuntime report="PM_TICKETS_ASSIGNED_TO_ME" />
              </Row>
            </>
          )}
        </div>
